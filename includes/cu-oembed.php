...
function embed_handler( $matches, $attr, $url, $rawattr ) {
	...
	$embed = sprintf( '<iframe src="https://lumenoea.herokuapp.com/assessments/load?src_url=https://lumenoea.herokuapp.com/api/assessments/%d.xml&results_end_point=https://lumenoea.herokuapp.com/api&assessment_id=%d&%s" frameborder="0" style="border:none;width:100%%;height:100%%;min-height:400px;"></iframe>',
		esc_attr( $matches[2] ),
		esc_attr( $matches[2] ),
		$parms
	);
