...
/**
 * @author  Lumen Learning <lumenlearning.com>
...
require_once ( WP_PLUGIN_DIR . '/pressbooks/includes/modules/import/class-pb-import.php' );
...
class IMSCCParser {
	...
	function setupManifest() {
		if ( ! is_file( $this->tempDir . '/imsmanifest.xml' ) ) {
			throw new \Exception( __( 'Unable to locate IMS CC manifest file.', 'pressbooks' ) );
		}
