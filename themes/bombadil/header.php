		...
		<?php if ( show_header() ) { ?>
			...
			<div class="header-nav">
				...
				<?php if ( show_header_link() ) { ?>
					<a class="book-title" href="<?php echo home_url( '/' ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home">
						<?php bloginfo( 'name' ); ?>
					</a>
				<?php } else { ?>
					<span class="book-title" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home">
						<?php bloginfo( 'name' ); ?>
					</span>
				<?php } ?>
